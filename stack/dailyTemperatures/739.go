...
func eleven(temperatures []int) []int {
	result := make([]int, len(temperatures))
	var stack []int
...
func twelve(temperatures []int) []int {
	result := make([]int, len(temperatures))
	var stack []int
...
func thirteen(temperatures []int) []int {
	result := make([]int, len(temperatures))
	var stack []int
...
func fourteen(temperatures []int) []int {
	result := make([]int, len(temperatures))
	var stack []int

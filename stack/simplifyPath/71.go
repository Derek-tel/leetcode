...
func eleven(path string) string {
	var stack []string
	for _, v := range strings.Split(path, "/") {
		if v == ".." {
			if len(stack) > 0 {
...
func twelve(path string) string {
	var stack []string
	for _, v := range strings.Split(path, "/") {
		if v == ".." {
			if len(stack) > 0 {
...
func thirteen(path string) string {
	var stack []string
	for _, v := range strings.Split(path, "/") {
		if v == ".." {
			if len(stack) > 0 {
...
func fourteen(path string) string {
	var stack []string
	for _, v := range strings.Split(path, "/") {
		if v == ".." {
			if len(stack) > 0 {

...
func seven(nums1 []int, nums2 []int) float64 {
	var helper func(int) int
	helper = func(i int) int {
		indexA, indexB := 0, 0
		for {
...
func eight(nums1 []int, nums2 []int) float64 {
	var helper func(int) int
	helper = func(i int) int {
		indexA, indexB := 0, 0
		for {
...
func nine(nums1 []int, nums2 []int) float64 {
	var helper func(int) int
	helper = func(i int) int {
		indexA, indexB := 0, 0
		for {
...
func ten(nums1, nums2 []int) float64 {
	var helper func(int) int
...
func eleven(nums1, nums2 []int) float64 {
	var helper func(int) int
	helper = func(k int) int {
		indexA, indexB := 0, 0
		for {
...
func thirteen(nums1, nums2 []int) float64 {
	var handler func(int) int
	handler = func(k int) int {
		indexA, indexB := 0, 0
		for {
...
func fourteen(nums1, nums2 []int) float64 {
	var handler func(int) int
	handler = func(k int) int {
		indexA, indexB := 0, 0
		for {
...
func fifteen(nums1, nums2 []int) float64 {
	var handler func(int) int
	handler = func(k int) int {
		indexA, indexB := 0, 0
		for {

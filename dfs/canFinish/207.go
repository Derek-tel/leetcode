...
func eleven(numCourses int, prerequisites [][]int) bool {
	var valid = true
	var visit = make([]int, numCourses)
	var edge = make([][]int, numCourses)
	var helper func(int)
...
func thirteen(numsCourses int, prerequisites [][]int) bool {
	var valid = true
	var visit = make([]int, numsCourses)
	var edge = make([][]int, numsCourses)
	var helper func(int)
	helper = func(index int) {
		visit[index] = 1
		for _, site := range edge[index] {
...
func fourteen(numsCourses int, prerequisites [][]int) bool {
	var valid = true
	var visit = make([]int, numsCourses)
	var edge = make([][]int, numsCourses)
	var helper func(int)
...
func fifteen(numsCourses int, prerequisites [][]int) bool {
	var valid = true
	var visit = make([]int, numsCourses)
	var edge = make([][]int, numsCourses)
	var helper func(int)
...
func sixteen(numCourses int, prerequisites [][]int) bool {
	var valid = true
	var visit = make([]int, numCourses)
	var edge = make([][]int, numCourses)
	var helper func(int)
...
func seventeen(numCourses int, prerequisites [][]int) bool {
	var valid = true
	var visit = make([]int, numCourses)
	var edge = make([][]int, numCourses)
	var helper func(int)

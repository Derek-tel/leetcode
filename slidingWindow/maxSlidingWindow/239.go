...
type elevenIndex []int

func (e elevenIndex) Swap(i, j int) {
	e[i], e[j] = e[j], e[i]
}

func (e elevenIndex) Less(i, j int) bool {
	return elevenList[e[i]] > elevenList[e[j]]
}

func (e elevenIndex) Len() int {
	return len(e)
}

func (e *elevenIndex) Push(x interface{}) {
	v := x.(int)
	*e = append(*e, v)
}

func (e *elevenIndex) Pop() interface{} {
	v := (*e)[len(*e)-1]
	*e = (*e)[:len(*e)-1]
	return v
}
...
type twelveIndex []int

func (t twelveIndex) Swap(i, j int) {
	t[i], t[j] = t[j], t[i]
}

func (t twelveIndex) Less(i, j int) bool {
	return twelveList[t[i]] > twelveList[t[j]]
}

func (t twelveIndex) Len() int {
	return len(t)
}

func (t *twelveIndex) Push(x interface{}) {
	v := x.(int)
	*t = append(*t, v)
}

func (t *twelveIndex) Pop() interface{} {
	v := (*t)[len(*t)-1]
	*t = (*t)[:len(*t)-1]
	return v
}
...
var thirteenList []int

type thirteenIndex []int

func (t thirteenIndex) Swap(i, j int) {
	t[i], t[j] = t[j], t[i]
}
func (t thirteenIndex) Less(i, j int) bool {
	return thirteenList[t[i]] > thirteenList[t[j]]
}
func (t thirteenIndex) Len() int {
	return len(t)
}
func (t *thirteenIndex) Push(x interface{}) {
	v := x.(int)
	*t = append(*t, v)
}
func (t *thirteenIndex) Pop() interface{} {
	v := (*t)[len(*t)-1]
	*t = (*t)[:len(*t)-1]
	return v
}
...
var fourteenList []int

type fourteenIndex []int

func (t fourteenIndex) Swap(i, j int) {
	t[i], t[j] = t[j], t[i]
}
func (t fourteenIndex) Less(i, j int) bool {
	return fourteenList[t[i]] > fourteenList[t[j]]
}
func (t fourteenIndex) Len() int {
	return len(t)
}
func (t *fourteenIndex) Push(x interface{}) {
	v := x.(int)
	*t = append(*t, v)
}
func (t *fourteenIndex) Pop() interface{} {
	v := (*t)[len(*t)-1]
	*t = (*t)[:len(*t)-1]
	return v
}
